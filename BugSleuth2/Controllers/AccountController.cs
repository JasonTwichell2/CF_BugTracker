...
namespace BugSleuth2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //
        // GET: /Account/LoginAsGuest
        [AllowAnonymous]
        public async Task<ActionResult> LoginAsGuest(string returnUrl, int? token)
        {
            if (token == 1)
            {
                var result = await SignInManager.PasswordSignInAsync("guest@BugSleuth2.com", "Password-1", false, shouldLockout: false);
            ...
            {
                var result = await SignInManager.PasswordSignInAsync("ajensen@coderfoundry.com", "Password-1", false, shouldLockout: false);
